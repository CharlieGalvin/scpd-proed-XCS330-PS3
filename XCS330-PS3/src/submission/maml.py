...
class MAML:
        ...
        for step in range(self._num_inner_steps + 1):
            ...
            if step < self._num_inner_steps:
                ...
                for parameter_name, gradient in zip(list(parameters.keys()), gradients):
                    parameters[parameter_name] = parameters[parameter_name] - self._inner_lrs[parameter_name]
    ...
    def _outer_step(self, task_batch, train):
        ...
        Returns:
            ...
            accuracies_ support (ndarray): support set accuracy over the
        ...
        for task in task_batch:
            ...
            ### START CODE HERE ###
            adapted_parameters, accuracies_support, _ = self._inner_loop(
                images_support, labels_support, train=train
            )
            accuracies_support_batch.append(accuracies_support)

            logits_query = self._forward(images_query, adapted_parameters)
            query_loss = F.cross_entropy(logits_query, labels_query)
